...
namespace TCC_V2
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void btn_log_Click(object sender, EventArgs e)
        {
            ...
            string query = "select cpf_funcionario, id_funcionario, senha_funcionario from funcionario where cpf_funcionario = @CpfFun and senha_funcionario = @SenhaFun;";
            List<MySqlParameter> parametros = new List<MySqlParameter>
            {
                new MySqlParameter("@CpfFun", log_user.Text),
                new MySqlParameter("@SenhaFun", log_user_pass1.Text)
            };
            ...
            if (dados.Read())
            {
                Session["user"] = dados["id_funcionario"].ToString();
